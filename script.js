...
function calculateSalary(x, b){
    ...
    let final = `Ele vai receber no total R$${saldoTotal},00 e a comissão é de R$${comissao},00`
...
function cashMachine(valorDoSaque, salarioFixo, vendas){
    ...
    let resultadu = `Você sacou R$${valorDoSaque} e vieram as seguintes notas: ${texto}e sobrou na sua conta R$${restanteSalario}.`
...
let test = 1521
let teste2 = "Você sacou R$789 e vieram as seguintes notas: 3 notas de R$200, 1 nota de R$100, 1 nota de R$50, 1 nota de R$20, 1 nota de R$10, 1 nota de R$5, 2 notas de R$2, e sobrou na sua conta 732 R$."
